...
//		L.LdoString(loadAssetsString("lua/hello.lua"));
		L.LdoString(loadAssetsString("vrsqiyi.lua"));

		// 实例1.Java调用lua函数
		L.getField(LuaState.LUA_GLOBALSINDEX, "parse"); // 取得lua里的plus函数
		String str = "{\"age\":\"23\",\"testArray\":{\"array\":[8,9,11,14,25]},\"url\":\"https://www.iqiyi.com/v_19rrdxxzoc.html\"}";
		L.pushString(str); // 传递参数1给plus函数
		L.call(1, 1); // 调用plus函数
